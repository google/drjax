...
def mesh_context(mesh: jax.sharding.Mesh, use_as_context: bool):
  """Context manager to provide the mesh to DrJax.

  If `use_as_context` then the mesh will be installed as the JAX global mesh and
  `None` will be returned. Otherwise the JAX global mesh will not be installed
  and the mesh will be returned. The return values should be passed to the DrJax
  function under test.

  Args:
    mesh: The mesh.
    use_as_context: Whether to install the mesh as the JAX global mesh.
